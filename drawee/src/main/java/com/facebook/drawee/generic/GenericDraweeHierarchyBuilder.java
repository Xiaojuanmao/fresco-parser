 ...
 *
 * 这个类是单独为GenericDraweeHierarchy创建的一个builder,每个Hierarchy都应该有自己的builder
 * 因为builder没有实现deep copy，类似drawable这类东西无法拷贝共享
 *
 * 每个View也都应该有自己的Hierarchy实例，不要多个View共享一个Hierarchy
 */
