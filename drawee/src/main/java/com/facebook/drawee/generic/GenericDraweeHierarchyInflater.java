...
public class GenericDraweeHierarchyInflater {
   ...
   *
   * 创建了一个Builder类，解析逻辑转给了updateBuilder方法
   */
   ...
   * 将xml里面的属性给builder设置上，更新builder里面存储的值
   *
   ...
   *
   * 对外开放该方法，而不是直接new一个builder，是为了方便自定义view的时候传入不同默认的值，在传入之前就能够对builder进行默认值的设定
   *
   ...
   *
   * 并没有管ImageView里面的ScaleType，设置了并不管用
   * 应该用draweeView提供的各种actualScaleType
   *
   */
  @Nullable
